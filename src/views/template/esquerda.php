<aside class="sidebar">
    <nav class="menu mt-3">
        <ul class="nav-list">
            ...
            <li class="nav-item">
                <a href="day_records.php"><i class="icofont-ui-calendar mr-2">Relatorio Mensal</i></a>

            </li>

            <li class="nav-item">
                <a href="day_records.php"><i class="icofont-chart-histogram mr-2">Relatorio Gerencial</i></a>
